...
trait ValidationSupport extends Matchers {
  ...
  val Being = InterfaceType("Being", List[TestField](
    Field("name", OptionType(StringType))(_ => None)
  ))
  ...
  val Dog = ObjectType("Dog", List[TestField](
    Field("name", OptionType(StringType))(_ => None),
    Field("nickname", OptionType(StringType))(_ => None),
    Field("barks", OptionType(BooleanType))(_ => None),
    Field("barkVolume", OptionType(IntType))(_ => None),
  ...
  val Cat = ObjectType("Cat", List[TestField](
    Field("name", OptionType(StringType))(_ => None),
    Field("nickname", OptionType(StringType))(_ => None),
    Field("meows", OptionType(BooleanType))(_ => None),
    Field("meowVolume", OptionType(IntType))(_ => None),
    Field("furColor", OptionType(FurColor))(_ => None)),
    interfaces[Unit, Unit](Being, Pet))

  val CatOrDog = UnionType("CatOrDog", types = Dog :: Cat :: Nil)

  val Intelligent = InterfaceType("Intelligent", List[TestField](
    Field("iq", OptionType(IntType))(_ => None)
  ))
  ...
  val Human: ObjectType[Unit, Unit] = ObjectType("Human", () => List[TestField](
    Field("name", OptionType(StringType),
      ...
      resolve = _ => None),
    Field("pets", OptionType(ListType(OptionType(Pet))))(_ => None),
    Field("relatives", OptionType(ListType(OptionType(Human))))(_ => None)),
    interfaces[Unit, Unit](Being, Intelligent))

  val Alien = ObjectType("Alien", List[TestField](
    Field("numEyes", OptionType(IntType))(_ => None)),
    interfaces[Unit, Unit](Being, Intelligent))
  ...
  val QueryRoot = ObjectType("QueryRoot", List[TestField](
    Field("human", OptionType(Human),
      ...
      resolve = _ => None),
    Field("alien", OptionType(Alien))(_ => None),
    Field("dog", OptionType(Dog))(_ => None),
    Field("cat", OptionType(Cat))(_ => None),
    Field("pet", OptionType(Pet))(_ => None),
    Field("catOrDog", OptionType(CatOrDog))(_ => None),
    Field("dogOrHuman", OptionType(DogOrHuman))(_ => None),
    Field("humanOrAlien", OptionType(HumanOrAlien))(_ => None),
    Field("complicatedArgs", OptionType(ComplicatedArgs))(_ => None)
  ))
